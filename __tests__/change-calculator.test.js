...
//changeCalculator(1); should return {'1':1}

//changeCalculator(2); should return {'2':1}

//changeCalculator(7); should return {'5':1,'2':1}

//changeCalculator(13); should return {'10':1,'2':1,'1':1}

describe("changeCalculator function tests", () => {
	test("should return an object", () => {
		const testCalc = changeCalculator;
		expect(typeof testCalc(63)).toBe('object');
	});	
